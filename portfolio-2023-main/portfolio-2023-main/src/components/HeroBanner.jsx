...
import gmailIcon from "../assets/email-icon (2).png";
            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>Rahulbhat7169@gmail.com</div>
                    </div>
                ...
                >
                    <h1 className="text-[30px] md:text-[20px] 2xl:text-[89px] leading-[50px] md:leading-[25px]  2xl:leading-[92px] font-oswald uppercase">
                        full stack web developer 
                        <br className="invisible md:visible" />
                        {/* turning ideas into dynamic digital solutions */}
                    </h1>
                </motion.div>
                {/* BIG HEADING END */}
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Rahul  Bhat</span>
                    </div>
                    <div className="max-w-[510px]">
                        As a dedicated Full Stack Web Developer, I specialize in creating seamless and dynamic web applications.
                        With proficiency in both front-end and back-end technologies, I bring innovative solutions to complex problems.
                        My expertise in modern frameworks and libraries ensures robust, scalable, and user-centric designs. I am passionate about staying ahead of industry trends and continuously enhancing my skills to deliver exceptional digital experiences.
